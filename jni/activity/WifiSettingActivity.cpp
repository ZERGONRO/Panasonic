...
void WifiSettingActivity::onCreate() {
    ...
    mWindowConnectFailPtr = (ZKWindow*)findControlByID(ID_WIFISETTING_WindowConnectFail);
    mIconWifiPtr = (ZKTextView*)findControlByID(ID_WIFISETTING_IconWifi);
    ...
    mButtonWifiSwitchPtr = (ZKButton*)findControlByID(ID_WIFISETTING_ButtonWifiSwitch);
    ...
    mButtonBackPtr = (ZKButton*)findControlByID(ID_WIFISETTING_ButtonBack);
...
void WifiSettingActivity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, size_t callbackTabIndex) {
...
void WifiSettingActivity::MyNetworkNotify(int type , void *data) {
...
void WifiSettingActivity::registerUserTimer(int id, int time) {
	registerTimer(id, time);
}

void WifiSettingActivity::unregisterUserTimer(int id) {
	unregisterTimer(id);
}

void WifiSettingActivity::resetUserTimer(int id, int time) {
	resetTimer(id, time);
}
